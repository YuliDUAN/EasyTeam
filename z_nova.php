...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 赛事新星列表</strong> <a href=""
                                                                                 style="float:right; display:none;">添加字段</a>
        </div>
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">

                <li><a class="button border-main icon-plus-square-o" href="z_endnova.php"> 往期赛事新星</a></li>
            </ul>
        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                <?php
                include("z_mysql.php");
                $result = $conn->query("SELECT id,image,name,host,number FROM nova where state=1");
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-group"><a class="button border-main"
                                                         href='z_novaAdd.php?id=<?php echo $row[0] ?>&number=<?php echo $row[4] ?>'><span
