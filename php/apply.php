...
//            ?>
            <div style="width:100%">
                ...
                <form action="applyInfoAction.php?fid=<?php echo $row['uid']?>&rid=<?php echo $_SESSION['uid']?>&name=<?php echo $_SESSION['username']?>" enctype="multipart/form-data" method="POST">
