    ...
    <div class="body-content">
        <form method="post" class="form-x" action="z_modifyAction.php?ac_id=<?php echo $id ?>">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea class="input" name="skeywords" style="height:80px""><?php echo $row[2] ?></textarea>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="s_name" value="<?php echo $row[3] ?>"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="s_tel" value="<?php echo $row[4] ?>"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="s_qqu" value="<?php echo $row[5] ?>"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="s_time" value="<?php echo $row[6] ?>"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="s_address" value="<?php echo $row[7] ?>"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
