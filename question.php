    ...
    <div class="container">
        ...
        <div class="agileits_mail_grids">
            <div class="col-md-7 agileits_mail_grid_left">
                <div class="col-md-7 agileits_mail_grid_left"
                     style="float:right;width:100%;border-radius:10px;margin-bottom:50px;background-color: #ffffff">
                    <table class="table" style="padding-top:30px;word-break: break-all">
                        ...
                        while ($rows = mysqli_fetch_array($result2)) {
                            ...
                            <tr>
                                ...
                                <td class="anchorjs-icon"><font size="4" color="black"><?php echo $rows[2] ?></font>
                                </td>
                                <td class="anchorjs-icon"><font size="4" color="black"><?php echo $rows[3] ?></font>
                                </td>
                            </tr>
                            <?php
                        }
